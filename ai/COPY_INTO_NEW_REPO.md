...
### 1) Copy `ai/` folder to repo root

```bash
# Option A: Direct copy
cp -r /path/to/ai-agent-md-pack/ai /path/to/your/project/
...
### 2) Fill `ai/01_PROJECT_CONTEXT.md`
...
Follow [`ai/QUICKSTART.md`](QUICKSTART.md) to begin using AI agents.
...
### ✅ Check 1: Files exist
```bash
ls ai/00_INDEX.md ai/00_SYSTEM.md ai/01_PROJECT_CONTEXT.md
# Should show all three files
```

### ✅ Check 2: Context is filled
```bash
grep "app_name:" ai/01_PROJECT_CONTEXT.md
...
```
"Read ai/00_INDEX.md and tell me what workflows are available"
```
...
**Problem:** `ai/` folder is in subdirectory, not root
...
**Verify:** `ls ai/00_INDEX.md` should work from project root
...
**Solution:**
- Explicitly tell agent: "Read ai/00_INDEX.md"
- Check that files weren't corrupted during copy
- Verify file permissions: `chmod -R u+r ai/`
...
Edit [`ai/02_CONVENTIONS.md`](02_CONVENTIONS.md):
- Code style preferences
- Git commit format
- Security rules specific to your domain

### Default behaviors
Edit [`ai/03_DEFAULTS.md`](03_DEFAULTS.md):
- Preferred testing framework
- Linting tools
- Database migration approach

### Custom workflows
Add new workflows to [`ai/workflows/`](workflows/):
