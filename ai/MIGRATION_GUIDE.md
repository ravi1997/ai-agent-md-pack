...
**Old (v3):**
```
ai/profiles/DEFAULT.md
ai/profiles/PROD_SAFE.md
ai/profiles/AUTOFIX_AGGRESSIVE.md
```

**New (v4):**
```
ai/profiles/default.md
ai/profiles/production_safe.md
ai/profiles/aggressive_autofix.md
```
...
```bash
# Backup your current ai/ folder
cp -r ai/ ai.v3.backup/
```
...
```bash
grep -r "DEFAULT.md\|PROD_SAFE.md\|AUTOFIX_AGGRESSIVE.md" ai/
```
...
```bash
# From v4 template
cp ai-v4-template/ai/README.md ai/
cp ai-v4-template/ai/ARCHITECTURE.md ai/
cp -r ai-v4-template/ai/examples/ ai/
cp -r ai-v4-template/ai/autofill/ ai/
```
...
grep -A 5 "AUTO_CONTEXT" ai/01_PROJECT_CONTEXT.md

# Check no UPPERCASE profiles remain
ls ai/profiles/

# Check new files exist
ls ai/README.md ai/ARCHITECTURE.md ai/examples/
```
...
# Verify
ls ai/profiles/DEFAULT.md  # Should exist in v3
```
...
1. ✅ Test with a simple request: "Read ai/00_INDEX.md"
2. ✅ Verify autofill works: Leave some fields blank in AUTO_CONTEXT
3. ✅ Review new examples: Check `ai/examples/`
4. ✅ Read architecture docs: `ai/ARCHITECTURE.md`
