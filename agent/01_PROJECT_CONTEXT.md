...
app_name: ""              # REQUIRED (e.g., "my-fintech-app")
project_type: ""          # REQUIRED (python|nodejs|java|cpp|go|rust|flutter|static)
...
repo_root: "."            # usually "."
source_dir: ""            # src/|app/|lib/|backend/
build_system: ""          # cmake|gradle|maven|npm|poetry|cargo|go
package_manager: ""       # pip|npm|yarn|mvn|gradlew|go mod
...
entrypoint: ""            # main.py|index.js|App.java|main.go
run_cmd: ""               # "python app.py" | "npm start" | "./gradlew bootRun"
test_cmd: ""              # "pytest" | "npm test" | "go test ./..."
app_port: 8000            # Internal port the app listens on
