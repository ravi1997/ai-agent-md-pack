...
### Step 1: Copy the `ai/` folder
```bash
# Navigate to your project
cd /path/to/your/project

# Copy the ai folder
cp -r /path/to/ai-agent-md-pack/ai ./
...
nano ai/01_PROJECT_CONTEXT.md
# or
code ai/01_PROJECT_CONTEXT.md
```
...
```bash
# Tell your AI agent:
"Read ai/00_INDEX.md and help me fix this error: [paste error]"

# Or for features:
"Read ai/00_INDEX.md and implement: user authentication"

# Or for deployment:
"Read ai/00_INDEX.md and deploy to staging"
```
...
# Tell AI:
"Read ai/00_INDEX.md and set up a Flask project with:
- User authentication
- Database (PostgreSQL)
- Docker setup"
```
...
# Tell AI:
"Read ai/00_INDEX.md and set up:
- Tailwind CSS
- React Router
- API integration"
```
...
# Tell AI:
"Read ai/00_INDEX.md and help me set up [your stack]"
```
...
### Development
```
"Read ai/00_INDEX.md and implement feature: [feature name]"
"Read ai/00_INDEX.md and fix this bug: [paste error]"
"Read ai/00_INDEX.md and add tests for [component]"
```

### Debugging
```
"Read ai/00_INDEX.md and debug: 502 error"
"Read ai/00_INDEX.md and fix: Docker won't start"
"Read ai/00_INDEX.md and investigate: slow performance"
```

### Operations
```
"Read ai/00_INDEX.md and deploy to staging"
"Read ai/00_INDEX.md and run database migration"
"Read ai/00_INDEX.md and create rollback plan"
```
...
→ Be specific in your request: "Read ai/00_INDEX.md and [specific task]"

### "AI asking too many questions"
→ Fill more fields in `01_PROJECT_CONTEXT.md` (optional but helps)

### "Production safety blocking me"
→ You're in production! Check `ai/policy/ENV_DETECTION.md`
...
3. ✅ **Start using** - just tell AI to "Read ai/00_INDEX.md and..."
...
- **All Workflows:** `ai/workflows/README.md`
- **Examples:** `ai/examples/`

---

**Questions?** Check `ai/README.md` or ask your AI agent:
```
"Read ai/00_INDEX.md and explain how to [do something]"
```
